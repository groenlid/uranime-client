...
function program5(depth0,data) {
  ...
  data.buffer.push("<nav class=\"top-bar\">\n    <ul class=\"title-area\">\n        <li class=\"name\">\n            <h1><a href=\"#\">Uranime</a></h1>\n        </li>\n        <li class=\"toggle-topbar menu-icon\"><a href=\"#sidebar\" id=\"sidebarButton\"><span>Menu</span></a></li>\n        ");
  hashTypes = {'class': "STRING"};
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.SearchFormView", {hash:{
    'class': ("toggle-topbar search-icon search")
  },contexts:[depth0],types:["ID"],hashTypes:hashTypes,data:data})));
  data.buffer.push("\n        <!--<li class=\"toggle-topbar search-icon search\"><a href=\"#\"><span class=\"general icon-search\"></span></a></li>-->\n    </ul>\n\n    <section class=\"top-bar-section\">\n        <ul class=\"left\">\n            <li class=\"divider\"></li>\n            <li>");
  hashTypes = {};
